...
WARNING_CATALOG: dict[str, WarningSpec] = {
    ...
    "monthly_payment_higher_than_theoretical": WarningSpec(
        severity_suggested="yellow",
        description=(
            "La cuota mensual difiere más de un 5% de la cuota amortizable "
            "teórica a la misma tasa y plazo."
        ),
    ...
    "term_excessive": WarningSpec(
        severity_suggested="red",
        description=(
            "El plazo de financiamiento excede el máximo legal aplicable al "
            "tipo de inmueble."
        ),
    ...
    "down_payment_inconsistent": WarningSpec(
        severity_suggested="yellow",
        description=(
            "El porcentaje y el monto de la prima no cuadran con el precio al "
            "contado."
        ),
    ...
    "total_cost_not_disclosed": WarningSpec(
        severity_suggested="red",
        description=(
            "No se encuentra una cifra clara del costo total en el texto "
            "analizado."
        ),
        related_field=None,
    ),
