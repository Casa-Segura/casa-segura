      ...
      >
        ...
        >
          ...
          <p className="text-base leading-relaxed text-text-secondary">
            Subí el PDF o fotos del contrato y recibí un informe claro sobre
            cláusulas repetidas, avisos y riesgos típicos. Vos decidís con más
            contexto; la herramienta es de código abierto y está pensada para El
            Salvador.
          </p>
          ...
          <div className="rounded-[var(--radius-card)] border border-border bg-surface p-5 shadow-sm">
            ...
            <p className="mt-2 text-sm leading-relaxed text-text-secondary">
              El análisis de contratos está disponible en la web. La
              verificación de proyectos o vallas es una línea de trabajo futura;
              no es necesaria para usar el flujo actual.
            </p>
          ...
          >
            ...
            <p>
              Extraemos el texto del documento, lo evaluamos con una rúbrica
              transparente y armamos un informe con citas al contrato para que
              puedas contrastar cada punto.
            </p>
            <p>
