...
| 5 | T060–T066: Zavu **inbound** (receive WhatsApp photo/PDF) | F7 / US-05: Zavu **outbound** (deliver report summary + link) | These are different integrations. PRD scope is outbound. Inbound would be an EPIC-08 extension or post-MVP. |
